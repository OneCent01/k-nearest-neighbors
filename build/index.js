...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__enter__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__exit__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__merge__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__order__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sort__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__call__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__nodes__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__node__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__size__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__empty__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__each__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__attr__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__style__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__property__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__classed__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__text__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__html__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__raise__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__lower__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__append__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__insert__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__remove__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__datum__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__on__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__dispatch__ = __webpack_require__(31);
...
var trainingData = [{ x: 32, y: 40, identity: 1 }, { x: 5, y: 27, identity: 0 }, { x: 17, y: 9, identity: 0 }, { x: 50, y: 29, identity: 1 }, { x: 22, y: 46, identity: 1 }, { x: 10, y: 27, identity: 0 }, { x: 5, y: 9, identity: 0 }, { x: 56, y: 69, identity: 1 }, { x: 10, y: 69, identity: 2 }, { x: 5, y: 55, identity: 2 }, { x: 2, y: 44, identity: 2 }, { x: 8, y: 70, identity: 2 }];
...
var SubmitData = function SubmitData(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        "x:",
        _react2.default.createElement("input", { id: "x", type: "text", placeholder: "CA15-3 in U/mL" }),
        _react2.default.createElement("br", null),
        "y:",
        _react2.default.createElement("input", { id: "y", type: "text", placeholder: "CA27-29 in U/mL" }),
        _react2.default.createElement(
          "button",
          null,
          "Submit"
...
var smooth = function smooth(datum, max) {
  datum.x = datum.x / max.x * h;
  datum.y = datum.y / max.y * h;
  return datum;
};

var findNeighbors = function findNeighbors(data, k) {
  return data.map(function (datum) {
    allData.map(function (neighbor) {
      var xDiff = Math.abs(datum.x - neighbor.x);
      var yDiff = Math.abs(datum.y - neighbor.y);
      var distance = Math.sqrt(Math.pow(xDiff, 2) + Math.pow(yDiff, 2));
      var currentFartherNeighbor = datum.neighbors.find(function (dataNeighbor) {
        return dataNeighbor[0] > distance;
      });
      ...
      datum.neighbors.sort(function (a, b) {
        return b[0] - a[0];
      });
      return neighbor;
    });
...
module.exports = { findMax: findMax, smooth: smooth, findNeighbors: findNeighbors, h: h, w: w, allData: allData, riskColors: riskColors };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_selectAll__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_selection_style__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touch__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_touches__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_window__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_selection_on__ = __webpack_require__(5);
...
var _SubmitData = __webpack_require__(16);

var _SubmitData2 = _interopRequireDefault(_SubmitData);

var _d3Selection = __webpack_require__(18);

var _helpers = __webpack_require__(17);

var _TrainingData = __webpack_require__(15);
...
var KNearestNeighbors = function (_Component) {
  _inherits(KNearestNeighbors, _Component);

  function KNearestNeighbors(props) {
    _classCallCheck(this, KNearestNeighbors);

    var _this = _possibleConstructorReturn(this, (KNearestNeighbors.__proto__ || Object.getPrototypeOf(KNearestNeighbors)).call(this, props));

    _this.state = {
      data: props.training || _TrainingData2.default,
      h: props.h,
      w: props.w
    };
    _this.handleSubmit = _this.handleSubmit.bind(_this);
    _this.createBarChart = _this.createBarChart.bind(_this);
    _this.placeDatum = _this.placeDatum.bind(_this);
    _this.populateGraph = _this.populateGraph.bind(_this);
    _this.classifyAndPlot = _this.classifyAndPlot.bind(_this);
    _this.max = null;
    _this.svgSelection = null;
    return _this;
  }

  _createClass(KNearestNeighbors, [{
    ...
    value: function createBarChart() {
      this.svgSelection = (0, _d3Selection.select)(this.node);

      this.svgSelection.select('svg').attr("width", this.state.w).attr("height", this.state.h).enter().append('svg');
      this.svgSelection.append('rect').attr('x', 0).attr('y', 0).attr('width', this.state.w).attr('height', this.state.h).style("stroke", 'black').style("fill", "none").style("stroke-width", 4).enter().append('svg');
      this.populateGraph(this.state.data);
    }
  }, {
    key: 'placeDatum',
    value: function placeDatum(datum, encircle) {
      this.svgSelection.append('circle').attr('cx', datum.x).attr('cy', datum.y).attr('r', 5).attr('fill', _helpers.riskColors[datum.identity]).enter().append('svg');
    }
  }, {
    key: 'populateGraph',
    value: function populateGraph(data) {
      var _this2 = this;

      var adjust = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var encircle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

      if (this.max === null) {
        this.max = (0, _helpers.findMax)(data);
      };
      data.map(function (datum) {
        _helpers.allData.push(datum);
        if (adjust) {
          (0, _helpers.smooth)(datum, _this2.max);
        };
        _this2.placeDatum(datum, encircle);
        return datum;
      });
    }
  }, {
    key: 'classifyAndPlot',
    value: function classifyAndPlot(data) {
      var _this3 = this;
      ...
      data.map(function (datum) {
        return (0, _helpers.smooth)(datum, _this3.max);
      });
      (0, _helpers.findNeighbors)(data, 3);
      var formattedData = data.map(function (datum) {
        var neighborsIdentity = datum.neighbors.reduce(function (acc, neighbor) {
          acc[neighbor[1]] === undefined ? acc[neighbor[1]] = 1 : acc[neighbor[1]] = acc[neighbor[1]] + 1;
          return acc;
        }, []);
        var maximum = Math.max.apply(Math, _toConsumableArray(neighborsIdentity.filter(function (neighbor) {
          return neighbor;
        })));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('svg', { id: 'svg', style: { 'height': this.state.h }, ref: function ref(node) {
            return _this4.node = node;
          } }),
        _react2.default.createElement(_SubmitData2.default, { submit: this.handleSubmit })
      );
    }
  }]);
...
exports.default = KNearestNeighbors;
